  ...
  **************************************************
    ...
    task :up do
      ...
      if system(compose_env, "docker-compose up -d #{ENV['COMPOSE_ARGUMENTS']}")
        ...
        STDERR.puts '⛔️ Error! There was an error starting Bigseat services.'
      end
    end
    ...
    task :down do
      ...
      if system(compose_env, "docker-compose down #{ENV['COMPOSE_ARGUMENTS']}")
        ...
        STDERR.puts '⛔️ Error! There was an error stopping Bigseat services.'
      end
    end
    ...
    task :clean do
      ...
      if system(compose_env, "docker-compose down -v #{ENV['COMPOSE_ARGUMENTS']}")
        ...
        STDERR.puts '⛔️ Error! There was an error removing Bigseat service volumes.'
      end
    end
  end
end